...
public class BeatDownAction implements GameEnvironmentAction {
    int cardIdx;

    public BeatDownAction(int cardIdx) {
    ...
    @Override public boolean equals(Object o) {
        ...
        BeatDownAction that = (BeatDownAction) o;
