...
public class CatastropheAction implements GameEnvironmentAction {
    int cardIdx;

    public CatastropheAction(int cardIdx) {
    ...
    @Override public void doAction(GameState state) {
        ...
        state.playCard(action, -1, true, null, false, false, -1, -1);
        while (state.actionCtx == GameActionCtx.SELECT_ENEMY) {
            ...
            state.playCard(action, enemyIdx, true, null, false, false, -1, -1);
        }
    }
    ...
    @Override public boolean equals(Object o) {
        ...
        CatastropheAction that = (CatastropheAction) o;
    ...
    @Override public String toString() {
        return "CatastropheAction(" + cardIdx + ")";
    }
}
