...
public final class GameState implements State {
    ...
    public GameState(GameStateBuilder builder) {
        ...
        properties.nnInputProperties = new NNInputSchema();
        properties.nnInputProperties.setup(this);
        properties.inputLen = properties.nnInputProperties.inputLen;
...
//                            }
    ...
    public float[] getNNInput() {
        return properties.nnInputProperties.fillNNInput(this);
    }

    public String getNNInputDesc() {
        return properties.nnInputProperties.description;
    }
